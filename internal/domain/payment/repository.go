...
type PaymentReadRepository interface {
	GetAll(ctx context.Context, limit, offset int) ([]Payment, int64, error)
	GetByBookingId(ctx context.Context, bookingID int64, limit, offset int) ([]Payment, int64, error)
